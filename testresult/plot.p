...
set term png size 700, 900
set multiplot layout 3,2 title "Concurrency" font ",14"
...
set title "Concurrency 2 threads"
set size 0.5, 0.3
set origin 0.5, 0.6 
...
set title "Concurrency 4 threads"
set size 0.5, 0.3
set origin 0.0, 0.3 
...
set title "Concurrency 8 threads"
set size 0.5, 0.3
set origin 0.5, 0.3 
...
set title "Concurrency 16 threads"
set size 0.5, 0.3
set origin 0.0, 0.0 
#set output "Concurrency 16 threads.png" 
plot    "<awk -F, '{if($2 == 16){print $0}}' './Pool concurrency standard test.txt'" using 1:3 title 'Standard' with lines smooth unique, \
        "<awk -F, '{if($2 == 16){print $0}}' './Pool concurrency shared test.txt'" using 1:3 title 'Shared Pool' with lines smooth unique, \
        "<awk -F, '{if($2 == 16){print $0}}' './Pool concurrency thread local.txt'" using 1:3 title 'Thread local Pool' with lines smooth unique

set title "Concurrency 32 threads"
set size 0.5, 0.3
set origin 0.5, 0.0 
#set output "Concurrency 32 threads.png" 
plot    "<awk -F, '{if($2 == 32){print $0}}' './Pool concurrency standard test.txt'" using 1:3 title 'Standard' with lines smooth unique, \
        "<awk -F, '{if($2 == 32){print $0}}' './Pool concurrency shared test.txt'" using 1:3 title 'Shared Pool' with lines smooth unique, \
        "<awk -F, '{if($2 == 32){print $0}}' './Pool concurrency thread local.txt'" using 1:3 title 'Thread local Pool' with lines smooth unique
unset multiplot
